    ...
    <footer id="contact" className="px-4 sm:px-8 lg:px-16 py-12 sm:py-16 border-t border-border/60">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 sm:gap-10">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            <li><a href="#" className="transition-colors duration-500 ease-in-out hover:text-purple-700 dark:hover:text-purple-400">Privacy</a></li>
            <li><a href="#" className="transition-colors duration-500 ease-in-out hover:text-purple-700 dark:hover:text-purple-400">Terms</a></li>
            <li><a href="#" className="transition-colors duration-500 ease-in-out hover:text-purple-700 dark:hover:text-purple-400">Security</a></li>
          </ul>
        </div>
      </div>
