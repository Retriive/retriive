import { A as invariant, D as rootRouteId, _ as TSR_SCRIPT_BARRIER_ID, g as GLOBAL_TSR, j as decodePath, k as createLRUCache, v as createInlineCssPlaceholderAsset, x as getStylesheetHref, y as createInlineCssStyleAsset } from "./react-router+[...].mjs";
//#region node_modules/@tanstack/router-core/node_modules/seroval/dist/esm/production/index.mjs
...
var v$1 = Symbol.asyncIterator, pr = Symbol.hasInstance, R = Symbol.isConcatSpreadable, C = Symbol.iterator, dr = Symbol.match, gr = Symbol.matchAll, yr = Symbol.replace, Nr = Symbol.search, br = Symbol.species, vr = Symbol.split, Cr = Symbol.toPrimitive, P$1 = Symbol.toStringTag, Ar = Symbol.unscopables, tt = {
...
//#endregion
export { defaultSerovalPlugins as a, makeSerovalPlugin as c, getOrigin as i, attachRouterServerSsrUtils as n, createRawStreamRPCPlugin as o, getNormalizedURL as r, createSerializationAdapter as s, mergeHeaders as t };
