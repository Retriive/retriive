import "../_runtime.mjs";
import { a as NodeResponse, o as FastURL } from "../_libs/h3+rou3+srvx.mjs";
...
import { a as defaultSerovalPlugins, c as makeSerovalPlugin, i as getOrigin, n as attachRouterServerSsrUtils, o as createRawStreamRPCPlugin, r as getNormalizedURL, s as createSerializationAdapter, t as mergeHeaders } from "../_libs/@tanstack/router-core+[...].mjs";
import { t as createMiddleware } from "./createStart-Bbc6IrgI.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B2vZ9ACC.mjs");
...
var v = Symbol.asyncIterator, pr = Symbol.hasInstance, R = Symbol.isConcatSpreadable, C = Symbol.iterator, dr = Symbol.match, gr = Symbol.matchAll, yr = Symbol.replace, Nr = Symbol.search, br = Symbol.species, vr = Symbol.split, Cr = Symbol.toPrimitive, P = Symbol.toStringTag, Ar = Symbol.unscopables, ve = {
	[v]: 0,
	[pr]: 1,
	[R]: 2,
	[C]: 3,
...
async function Dr(e, r, t) {
	...
	return C in t && (a.push(I(e.base, C)), s.push(Ue(rr(e.base), await N(e, r, $e(t))))), v in t && (a.push(I(e.base, v)), s.push(je(tr(e.base), await N(e, r, Qe(t))))), P in t && (a.push(I(e.base, P)), s.push($(t[P]))), R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)), {
		k: a,
		v: s
	};
}
...
function io(e, r, t) {
	return Wt(e, r, t, b(e, t.i, new AggregateError([], D(t.m))));
}
function uo(e, r, t) {
	let n = Br(t, st, t.s);
	return Wt(e, r, t, b(e, t.i, new n(D(t.m))));
}
function lo(e, r, t) {
...
function go(e, r, t) {
	p(e, r, t.a[0]);
	return Rt(p(e, r, t.a[1]));
}
function yo(e, r, t) {
	p(e, r, t.a[0]);
	return wt(p(e, r, t.a[1]));
}
function No(e, r, t) {
	let n = b(e, t.i, re());
	Yt(e, t.i, 31);
...
function Zr(e, r, t) {
	...
	return C in t && (a.push(I(e.base, C)), s.push(Ue(rr(e.base), E(e, r, $e(t))))), v in t && (a.push(I(e.base, v)), s.push(je(tr(e.base), E(e, r, e.type === 1 ? re() : Qe(t))))), P in t && (a.push(I(e.base, P)), s.push($(t[P]))), R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)), {
		k: a,
		v: s
	};
}
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-wxQ3pihu.mjs"),
		import("./start-BPb3d-52.mjs"),
		import("./empty-plugin-adapters-DUKJXCaV.mjs")
	]);
	return {
		routerEntry,
		startEntry,
